...
public class NavigationColumnGPACalculatorTest extends AbstractWebTest {
    ...
    @Test
    @Order(3)
    @DisplayName("Third, click on the GPA Calculator Navigation Column Button.")
    void navigateToGPACalculator() {
        navCol = hoursAndLocationsPage.getSideNavColumn();
        navCol.navigateToGPACalculator();
        sleep(3);
    }
    ...
    void validateNavigation() {
        ...
        assertEquals("https://tigercenter.rit.edu/tigerCenterApp/api/gpa-calc", gpaCalc.getURL());
    }
}
